...
class HorizontalVector : public Vector {
 public:
    ...
    HorizontalVector slice(size_t start_ind, size_t end_ind) const;
    HorizontalVector lslice(size_t start_ind) const;
    HorizontalVector rslice(size_t end_ind) const;
};
...
class VerticalVector : public Vector {
 public:
    ...
    VerticalVector slice(size_t start_ind, size_t end_ind) const;
    VerticalVector lslice(size_t start_ind) const;
    VerticalVector rslice(size_t end_ind) const;
};
